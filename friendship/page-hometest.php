				...
				<div class="row">
					<div class="small-12 large-6 large-push-3 columns">
						<div class="overlayingInner">
							...
							?>
								<p><a href="<?php echo $ctabuttonurl; ?>" id="home-top-cta" class="button"><?php echo $ctabuttontxt; ?></a> <a href="<?php echo $ctabuttonurl2; ?>" id="home-top-cta-2" class="button light"><?php echo $ctabuttontxt2; ?></a></p>
					...
					<div class="small-12 large-3 large-pull-6 columns">
						<div class="overlayingInner margin-bottom semitrans">
							<div class="ontop">
								...
								<a href="/store/mens-shoes/" class="imgLink"><img src="http://www.louisianarunning.com/wp-content/uploads/2016/05/mensShoes.jpg"/></a>
							</div>
						</div>
						<div class="overlayingInner semitrans">
							<div class="ontop">
								<h3><a href="/store/womens-shoes/">Women's Shoes</a></h3>
								<a href="/store/womens-shoes/" class="imgLink"><img src="http://www.louisianarunning.com/wp-content/uploads/2016/05/womensShoes.jpg"/></a>
							</div>
						</div>
					</div>
					<div class="small-12 large-3 columns">
						<div class="overlayingInner margin-bottom semitrans">
							<div class="ontop">
								...
								<a href="/store/sale/" class="imgLink"><img src="http://www.louisianarunning.com/wp-content/uploads/2016/05/mensApparel.jpg"/></a>
							</div>
						</div>
						<div class="overlayingInner semitrans">
							<div class="ontop">
								<h3><a href="/store/apparel/">Apparel</a></h3>
								<a href="/store/apparel/" class="imgLink"><img src="http://www.louisianarunning.com/wp-content/uploads/2016/05/womensApparel.jpg"/></a>
							</div>
						</div>
					</div>
...
<section class="featured store">
	...
	<div class="row fuller">
		...
		<div class="small-12 columns">
			<p class="">
				<a class="button radius" href="<?php the_field('store_section_button_url');?>" title="<?php the_field('store_section_button_text');?>"><?php the_field('store_section_button_text');?></a>
			</p>
		</div>
	</div>
...
<section class="articles">
	<div class="row fullwidth">
		<div class="small-12 columns">
			<h2><a href="http://www.louisianarunning.com/category/in-the-community/">In the Community</a></h2>
...
<section class="runGroups">
	<div class="row fullwidth">
		<div class="small-12 columns">
			<h2><a href="http://www.louisianarunning.com/category/rungroup/">Run Groups &amp; Store News</a></h2>
