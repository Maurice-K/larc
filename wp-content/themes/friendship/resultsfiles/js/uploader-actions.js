jQuery(document).ready(function() {
    ...
    function submitRunners(formId, event_id, race_id) {
		...
		$.ajax({
    		method: "POST",
    		url: "/wp-content/themes/friendship/resultsfiles/additems.php",
    ...
    function eventsPhase(data) {
    	...
    	$.ajax({
    		method: "GET",
    		url: "/wp-content/themes/friendship/resultsfiles/listitems.php?listwhat=eventsAndTypes",
    		cache: false,
    		contentType: false,
    		success: function(json) {
...
*******************************************************/
    function schoolsPhase(data) {
    	...
    	$.ajax({
    		method: "GET",
    		url: "/wp-content/themes/friendship/resultsfiles/listitems.php?listwhat=schools",
    		cache: false,
    		contentType: false,
    		success: function(json) {
    			var parsedJSON = JSON.parse(json);
				...
				$.each(schoolsList, function(key, value) {
					...
					$.each(parsedJSON.data, function(idx, val) {
						var cityText = '';
						selectedText = '';
						if (isSimilar(escape(val.title), escape(value)) || hasWordsOfEachOther(val.title, value)) {
							if (escape(val.title) === escape(value)) {
								selectedText = 'selected';
							}
							if (val.city) {
								cityText = ' - ' + val.city;
    ...
    function runnersPhase(data) {
		...
		$.ajax({
    		method: "GET",
    		url: "/wp-content/themes/friendship/resultsfiles/listitems.php?listwhat=runners",
    		cache: false,
    		contentType: false,
    		success: function(json) {
    			var parsedJSON = JSON.parse(json);
